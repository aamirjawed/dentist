    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <button
          ...
          className="md:hidden flex items-center justify-center p-2 rounded-lg text-[#0A2540] hover:bg-gray-105 transition-colors"
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-[#CBD6DC] shadow-xl border-b border-gray-300/40 absolute top-full left-0 right-0 py-6 px-6 flex flex-col space-y-4 transition-all duration-300">
          <a
            href="#services"
